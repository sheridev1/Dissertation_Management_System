...
if (isset($_POST['supervisor'])) {
    ...
    $scope = $_POST['scope'];
    $sql = "UPDATE `projects` SET `title`='" . $title . "',`discipline`='" . $discipline . "',`area`='" . $area . "',`supervisor`='" . $supervisor . "',`website`='" . $website . "',`overview`='" . $overview . "',`details`='" . $details . "',`type`='" . $type . "',`startdate`='" . $sdate . "',`enddate`='" . $edate . "',`type2`='" . $type2 . "',`members`='" . $members . "',`scope`='" . $scope . "',`approve`='" . 0 . "' WHERE pid=" . $_POST['pid'];
            ...
            <form method="post" enctype="multipart/form-data" action="#">
                <div class="content with-padding padding-bottom-10">
                    <div class="row">
                        ...
                        <div class="submit-field">
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <option value="<?php echo $row['id']; ?>" <?php if($supervisor==$row['id']) echo 'selected'; ?> ><?php echo $row['fname'] . ' ' . $row['lname'];?>
                                </option>
                    ...
                    <div class="col-xl-3 " id='sm1'>
                        <div class="submit-field">
                            <h5>Member Name</h5>
                            <input type="text" class="with-border" name="mem1"
                                placeholder="" readonly value="<?php echo $_SESSION['fullname'] ;?>" />
                        </div>
                    </div>
