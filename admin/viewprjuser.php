...
if($_POST['type']=='super'){
	$sql = 'SELECT projects.*, student.*, supervisor.*
	FROM projects
	LEFT JOIN student ON projects.studentid = student.id
	LEFT JOIN supervisor ON projects.supervisorId = supervisor.id
	WHERE pid=' . $_POST['prjid'];
				...
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a><img
									src="<?php echo $row['img'];?>" alt=""></a></div>
