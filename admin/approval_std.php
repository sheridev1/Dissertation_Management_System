...
if (isset($_POST['usapp'])) {
    $us = $_POST['usapp'];
    $sql = "update `student` set approve=1 where  username='" . $us . "' ";
    $con->query($sql);
}
...
$sql = "select * from student where approve=0";
                    ...
                    <?php while ($row = $result->fetch_assoc()) { ?>
                        <li>
                                    ...
                                    <div class="job-listing-description">
                                        ...
                                        <div class="job-listing-footer">
                                            <ul>
                                                ...
                                                <li><i class="icon-material-outline-check-circle"></i>
                                                    <?php echo $status ?>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="buttons-to-right">
                                <a href="#" class="button green ripple-effect " title="Approve"
                                    onclick="submitForm('<?php echo $row['username']; ?>');">Approve</a>

                                <a href="#" class="button red ripple-effect ico" title="Remove"
                                    onclick="delsubmitForm('<?php echo $row['username']; ?>', '<?php echo $row['img']; ?>');"><i
