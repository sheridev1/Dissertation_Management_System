...
<div class = 'content '>
    <form method="post" action='/supervisor/feedback.php' id="super_message">
        <?php if($_POST['approve']==0){?>
            <div class="col-xl-12">
        <div class="submit-field">
                    <h5>Action</h5>
                    <select class="selectpicker with-border" name="action" data-size="7" title="Action">
                ...
                <div class="submit-field">
                    ...
                    <textarea class="with-border" name="feedback" rows="4"></textarea>
                </div>
            </div>
            <div class="col-xl-12">

                <button type="submit" style='color:white' name="submit"
                    class="button ripple-effect big">Save </button>
        </form>
        </div>
        </div>
        </div>
