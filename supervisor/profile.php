...
if (isset($_POST['imgclick'])) {
    ...
    if ($uploadOk == 0) {
        ...
        $sql = "select username from supervisor where id=" . $_SESSION['id'];
        ...
        if (move_uploaded_file($_FILES["img"]["tmp_name"], $imgsrc)) {
            $sql = "UPDATE `supervisor` SET `img`='" . $imgsrc . "' WHERE id=" . $_SESSION['id'];
            if ($con->query($sql)) {
                $_SESSION['img'] = $imgsrc;
...
if (isset($_POST['fname'])) {
    ...
    $email = $_POST['em'];
    $gender = $_POST['gender'];
    $sql = "UPDATE `supervisor` set `fname`='" . $fname . "',`lname`='" . $lname . "',`university`='" . $university . "',`country`='" . $country . "',`username`='" . $username . "',`pass`='" . $pass . "',`email`='" . $email . "',`gender`='" . $gender . "',`qualifications`='" . $qual . "' WHERE id=" . $_SESSION['id'];
...
$sql = "SELECT * FROM `supervisor`  where id=" . $_SESSION['id'];
$result = $con->query($sql);
