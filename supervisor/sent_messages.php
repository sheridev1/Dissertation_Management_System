...
include 'header.php';
$query_announcement = mysqli_query( $con, 'select * from message_sent LEFT JOIN supervisor ON supervisor.id = message_sent.reciever_id where  sender_id =' . $_SESSION[ 'id' ] . ' order by date_sended DESC ' ) or die( mysqli_error() );
...
if ( $count_my_message != '0' ) {
    while( $row = mysqli_fetch_array( $query_announcement ) ) {
        ...
        Send To:<?php echo $row[ 'reciever_name' ] ?>
        </a>
